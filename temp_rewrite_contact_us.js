        ...
        <div className="lg:col-span-7">
           <div className="rounded-[32px] bg-white p-8 md:p-12 border border-secondary/5 shadow-[0_20px_40px_rgba(6,18,37,0.06)]">
              <form className="space-y-6">
                 ...
                 <button type="submit" className="w-full group relative inline-flex items-center justify-center gap-3 overflow-hidden rounded-xl bg-[#25CA22] px-8 py-4 text-[15px] font-bold text-white transition-all hover:bg-[#20b21e] hover:shadow-[0_15px_30px_rgba(37,202,34,0.3)] mt-2">
...
fs.writeFileSync(path.join(__dirname, 'src/components/contact-page/ContactPageContent.tsx'), content);
...
`
fs.writeFileSync(path.join(__dirname, 'src/app/contact-us/page.tsx'), pageContent.trim() + '\n');
console.log('Contact Us page rewritten.');
