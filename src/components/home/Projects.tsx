        ...
        <div className="mb-10 space-y-5 text-center md:mb-[70px]">
          ...
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>AI solutions powering real businesses.</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p className="mx-auto max-w-[680px]">
                Explore how RockScale has helped startups, SMEs, and mid-size companies unlock growth, streamline operations, and future-proof their businesses through AI.
              </p>
            </RevealAnimation>
          </div>
        </div>
