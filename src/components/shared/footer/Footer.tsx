            ...
            <div className="col-span-12 xl:col-span-4">
              <div className="max-w-[306px]">
                ...
                <p className="text-accent/60 text-tagline-1 mt-4 mb-7 font-normal">
                  RockScale helps startups, SMEs, and mid-size companies accelerate their growth by leveraging AI, data, and cloud infrastructure.
                </p>
        ...
        <div className="relative pt-[26px] pb-[42px] text-center">
          ...
          <RevealAnimation delay={0.7} offset={10} start="top 105%">
            <p className="text-tagline-1 text-primary-50 font-normal">
              Copyright ©RockScale. AI Solutions & Infrastructure
            </p>
          </RevealAnimation>
        </div>
      </div>
